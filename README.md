...
- Build date: 2025-04-10T20:56:07.415877004Z[Etc/UTC]
...
```shell
gem install ./conekta-6.0.6.gem
```

(for development, run `gem install --dev ./conekta-6.0.6.gem` to install the development dependencies)
